...
In general, we follow the standard GitHub workflow which roughly works like this:
 ...
 6. Sign the necessary [CLA](./cla_docs/cla.md) either directly in the PR via the bot, or sent the signed document to cla@tribe29.com ([further information](./cla_docs/cla_readme.md)). 
